    ...
    <div className="footer">
      ...
      <div className="address-container">
        ...
        <div className="address">
          ...
          <div className="addy">BTC: <p id="btc-addy">bc1qutvrfse6q4n3073lcr3thpx46xyr9tx50nz3h9</p><i className="fa-solid fa-clipboard btc" onClick={() => copyElementText("btc-addy", "btc")}></i></div>
        </div>
        <div className="address">
          <img
          ...
          <div className="addy">ETH: <p id="eth-addy">0x98c0fe160b049d3436d2c3c26bf454fcfad2a8c1</p><i className="fa-solid fa-clipboard eth" onClick={() => copyElementText("eth-addy", "eth")}></i></div>
        </div>
        <div className="address">
          <img
